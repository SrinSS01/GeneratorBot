...
public class ActivationStatus {
    ...
    private static final String OWNER_ID = "nv8jWRD50g";// "gtuyAi7EKl"; // You can find out the owner id in the profile settings keyauth.com
    private static final String APP_NAME = "TestSellix";// "GeneratorBot"; // Application name
